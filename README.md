...
The advantages of this approach is to be able to create Rich User experiences in a uniform way, without compromising Search Engine Optimisation (SEO) factors that are key to good ranking ing Google and other search engines. 

This boilerplate make it easier to get started a creating well-structured app with Next.js and TypeScript.
